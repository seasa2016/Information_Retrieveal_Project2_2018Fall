...
# File paths
file_dir = '../data/'
embedding_dir = '../directory_containing_pre-trained_GoogleNews-vectors-negative300.bin/'
...
term_cols = ['word_1', 'word_2', 'node_1', 'node_2']
...
node1_input = Input(shape=(embedding_dim,), dtype='float32')
node2_input = Input(shape=(embedding_dim,), dtype='float32')
