...
lexical_feat = [np.array(list(test_noun1[i][0]) + list(test_noun2[i][0]) + \
                         ...
                         list(test_RT[i][0])) for i in range(test_data_size)] # shape: 16959 x (256 x 6)
...
# 4. Load Model
model = keras.models.load_model('savings/edge_detection_cnn.h5')
...
print(accuracy, macro_f1) # 0.7633955448524985 0.6160218700906733
